...
power = 400E-3 # Total power of the beam.
sigma = 10  # sigma is the parameter to describe the gaussian.
no_of_rays = 200   # Number of rays we are going to trace
...
droplet_pos = [400, 0, 0, 0, 0]      # Central position of the droplet [x, y, vx, vy, t]
density = 960 # kg/m^3
'''
Parameters for lens
'''
